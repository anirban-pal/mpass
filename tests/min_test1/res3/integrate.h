int func(double t, const double W[], double f[], void *fn_data)
{
  ...
  loop(i,np) loop(j,3) if(!isnan(W[i*3+j])) FN->CPx[i].comp[j] = W[i*3+j];
  loop(i,np) loop(j,3) if(!isnan(W[i*3+j+np*3])) FN->CPv[i].comp[j] = W[i*3+j+np*3];
  
  //loop(i,np) printf("funcSTEP2: %d %lf %lf %lf %lf %lf %lf\n",i+1,FN->CPx[i].comp[0],FN->CPx[i].comp[1],FN->CPx[i].comp[2],FN->CPv[i].comp[0],FN->CPv[i].comp[1],FN->CPv[i].comp[2]);
  ...
  //loop(i,np) printf("funcSTEP4: %d %lf %lf %lf %lf %lf %lf\n",i+1,FN->CPx[i].comp[0],FN->CPx[i].comp[1],FN->CPx[i].comp[2],FN->CPv[i].comp[0],FN->CPv[i].comp[1],FN->CPv[i].comp[2]);
  //loop(i,2*np) printf("funcSTEP4(f): %d %lf %lf %lf %lf %lf %lf\n",i+1,f[i*3],f[i*3+1],f[i*3+2]);
...
void integrate(fibnetwork &fn, int nsteps, double tstep)
{
  ...
  //loop(i,np)
    //printf("intSTEP0: %d %lf %lf %lf %lf %lf %lf\n",i+1,fn.CPx[i].comp[0],fn.CPx[i].comp[1],fn.CPx[i].comp[2],fn.CPv[i].comp[0],fn.CPv[i].comp[1],fn.CPv[i].comp[2]);
  ...
  //loop(i,np)
    //printf("intSTEP1: %d %lf %lf %lf %lf %lf %lf\n",i+1,fn.CPx[i].comp[0],fn.CPx[i].comp[1],fn.CPx[i].comp[2],fn.CPv[i].comp[0],fn.CPv[i].comp[1],fn.CPv[i].comp[2]);
